        ...
        gradient: {
          ...
          colors: [
           ...
           // { color: 'rgba(255, 255, 255, 0)', offset: '20%' },    // Keep transparent longer
            ...
            { color: 'rgba(252, 235, 220, 0.5)', offset: '75%' },  // Soft peach
            { color: 'rgba(255, 210, 180, 0.7)', offset: '100%' },  // Gentle orange
      ...
      return {
        gradient: {
          ...
          colors: [
           // { color: 'rgba(255, 255, 255, 0)', offset: '0%' },     // Transparent at top
           // { color: 'rgba(255, 255, 255, 0)', offset: '20%' },    // Keep transparent longer
           { color: 'rgba(180, 215, 255, 0.85)', offset: '100%' },
            { color: 'rgba(200, 225, 255, 0.75)', offset: '80%' },
            { color: 'rgba(215, 235, 255, 0.6)', offset: '65%' },  
