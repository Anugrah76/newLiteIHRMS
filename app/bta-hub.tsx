...
import { CalendarPlus, CalendarCheck2 } from 'lucide-react-native';

const { width } = Dimensions.get('window');
const isTablet = width > 768;

export default function BTAHubScreen() {
    ...
    const menuItems = [
        {
            title: 'Create BTA',
            subtitle: 'Submit new business trip request',
            icon: CalendarPlus,
            route: '/bta-calendar',
            color: '#3B82F6'
        },
        {
            title: 'My BTA List',
            subtitle: 'View your trip applications',
            icon: CalendarCheck2,
            route: '/bta/my-events',
            color: '#10B981'
        },
        {
            ...
            subtitle: 'Review team BTA requests',
            icon: CalendarCheck2,
            route: '/bta',
            color: '#8B5CF6'
        },
