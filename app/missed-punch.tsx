...
import { useMissedPunchList, useApproveMissedPunch } from '@features/misc/hooks';
import { CheckCircle, XCircle } from 'lucide-react-native';

export default function MissedPunchScreen() {
    const theme = useTheme();
    const toast = useToast();
    const { data: list, isLoading, refetch } = useMissedPunchList();
    const { mutate: approve } = useApproveMissedPunch();
    ...
    return (
        <CorporateBackground>
            <TopBar title="Missed Punch Approvals" onMenuPress={() => { }} showBack={true} />
