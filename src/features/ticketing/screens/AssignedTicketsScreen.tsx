...
import { useAssignedTickets } from '../hooks/useTicketing';
...
export default function AssignedTicketsScreen() {
    ...
    const { data: tickets, isLoading } = useAssignedTickets(year, month, status);
    ...
    return (
        <CorporateGradient>
            <SafeAreaView style={styles.container}>
                <TopBar title="Assigned Tickets" showBack />
